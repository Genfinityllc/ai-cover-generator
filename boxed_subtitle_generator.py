...
class BoxedSubtitleGenerator:
    ...
    def get_refined_brand_prompts(self, client="hedera"):
        ...
        brand_prompts = {
            "hedera": {
                "base": "Hedera hashgraph technology background with prominent H logo symbols, purple and blue gradient technology environment",
                "logos": "large prominent Hedera H logo symbols integrated into background design, white circular H logos scattered throughout composition, Hedera branding elements as design focus, multiple H symbols in hexagonal arrangements",
                "tech": "hashgraph network nodes with visible connections, DAG structure visualization, distributed ledger technology patterns, hexagonal grid overlay with H symbols",
                "quality": "professional enterprise technology photography, 8k resolution, corporate lighting, premium blockchain aesthetic"
            },
            
            "algorand": {
                "base": "Algorand blockchain technology background with triangular logo elements, teal and black professional environment",
                "logos": "prominent Algorand triangular logo symbols integrated throughout design, large A symbols as background elements, geometric Algorand branding prominently featured, multiple triangular logos in clean arrangements",
                "tech": "pure proof of stake visualization with triangular nodes, consensus mechanism patterns, Layer-1 blockchain structure, geometric network topology with Algorand symbols",
                "quality": "corporate fintech photography, 8k resolution, clean professional lighting, premium DeFi aesthetic"
            },
            
            "constellation": {
                "base": "Constellation DAG network background with star logo symbols, cosmic blue and purple space environment",
                "logos": "prominent Constellation star logo symbols floating throughout space, large star symbols integrated into cosmic design, constellation branding as focal elements, multiple star logos in stellar patterns",
                "tech": "DAG network visualization with star-shaped nodes, cosmic data consensus patterns, microservice architecture in space theme, stellar network topology with constellation symbols", 
                "quality": "cinematic space technology photography, 8k resolution, cosmic lighting effects, premium space-tech aesthetic"
            }
        }
